...
def main():
    ...
    parser.add_argument('--model', default="birefnet-general", type=str, 
        help="Default: 'birefnet-general' - A pre-trained model for general use cases. Available models at: 'https://github.com/danielgatis/rembg'")
    ...
    for class_folder in listdir(root):
        ...
        for picture_name in listdir(fr"{root}\{class_folder}"):
            ...
            print(f"*** Removing background from [{picture_name}] ... ", end='', flush=True)
